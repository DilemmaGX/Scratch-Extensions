...
class Animator {
    ...
    constructor(runtime) {
        ...
        this._formatMessage = runtime.getFormatMessage({
            'zh-cn': {
                ...
                'Ani.docUrl': 'https://learn.ccw.site/article/63a876b1-ccd4-4e74-a298-04e94109ab95'
            },
            ...
            en: {
                ...
                'Ani.docUrl': 'https://dilemmagx.github.io/Scratch-Extensions/doc/Animator.html'
            }
        })
    }
    /**
    ...
    docs() {
        window.open(this.formatMessage('Ani.docUrl'));
    }
    /**
     * 获取动画效果。
