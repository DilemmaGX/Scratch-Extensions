...
class Animator {
            ...
            blocks: [
                {
                    ...
                    onClick: this.formatMessage('Ani.docsOP')
                },
    ...
    en_docs(){
        const a = document.createElement('a');
        a.href = 'https://dilemmagx.github.io/Scratch-Extensions/doc/Animator.html';
        a.rel = 'noopener noreferrer';
        a.target = '_blank';
        a.click();
    }
